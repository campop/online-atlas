...
class onlineAtlas extends frontControllerApplication
{
	...
	public function defaults ()
	{
		...
		$defaults = array (
			...
			'intervalsMode' => false,
			'valueUnknown' => NULL,	// For all decimal fields, special value which represents unknown data; if the real value is NULL, set it to string 'NULL' and this will be treated as real NULL
	...
	public function main ()
	{
		...
		# If the value is 'NULL', treat as real NULL
		if ($this->settings['valueUnknown'] == 'NULL') {
			$this->settings['valueUnknown'] = NULL;
		}
	...
	{
		# Preformat valueUnknown
		switch (true) {
			case is_bool ($this->settings['valueUnknown']):
			case is_numeric ($this->settings['valueUnknown']):
				$valueUnknownJS = $this->settings['valueUnknown'];
				break;
				
			case is_null ($this->settings['valueUnknown']):
				$valueUnknownJS = 'null';
				break;
